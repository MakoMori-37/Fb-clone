      ...
      {open ?
        ...
        <div className='postmodal' >
          <div className="hmodal">
              <h3>สร้างโพสต์</h3>
              <div className="closebut" onClick={() => { setOpen(prev => !prev)}} >
                <CloseIcon/>
              </div>
          </div>
          ...
          <div className="textarea">
            <textarea  placeholder='คุณคิดอะไรอยู่ Eunbi' />
          </div>
          ...
          <div className="modaltools">
            ...
            <FaUserTag color='blue' size='20px' />

                </div>

                <div className="modalemo">

            <TagFacesIcon/>
                </div>

                <div className="modalloca">
