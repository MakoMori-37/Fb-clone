  ...
  return (
    <div className="sidemenu">
      <div className="sidemenu__head">
        ...
        <div className="sidemenuh__name">
          <p>Kwon Eunbi</p>
          <span>ดูโปรไฟล์ของคุณ</span>
        </div>
        </div>

        <div className="underlineside"></div>

        <div className="sidemunu__comment">
          <div className="sidemunec__icon">
            <AnnouncementIcon />
          </div>

          <div className="sidemunec__com">
            <p>แสดงความคิดเห็น</p>
            <span>ช่วยเราปรับปรุง Facebook ใหม่</span>
          </div>
        </div>

        <div className="underlineside"></div>

        <div className="sidemunu__item">
          <div className="sidemenuitem__item">
            <SettingsIcon />
          </div>

          <div className="tx">การตั้งค่าและความเป็นส่วนตัว</div>

          <div className="sidemenuitem__i">
            <ChevronRightIcon />
          </div>
        </div>
        ...
        <div className="sidemunu__item">
          ...
          <div className="tx">ความช่วยเหลือและการสนับสนุน</div>
        ...
        <div className="sidemunu__item">
          <div className="sidemenuitem__itemm">
            <Brightness2Icon />
          </div>

          <div className="tx">การตั้งค่าการแสดงผล</div>
        ...
        <div className="sidemunu__item">
          ...
          <div className="tx">ออกจากระบบ</div>
        </div>
     


            <div className="sidemenu__footer">
            <p>ความเป็นส่วนตัว  · เงื่อนไข  · ลงโฆษณา  · ตัวเลือกโฆษณา    ·  คุกกี้   · Facebook © 2020</p>
